...
\title[Lecture 4]{\large AI2100/EE5609 Convex Optimization Theory \\ \LARGE Lecture 4.1: Polyhedra,  Norm Balls, Norm Cones}
...
\begin{axis}[
        ...
        \addplot [domain=-2:1,samples=250,  ultra thick , blue] ({cos(x)}, {sin(x)});
